...
Public Class saveimage : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        CreateCover(filecover, 1600, 1600, rndStr & ".jpg", sMapPath) 'Resize image to max 1600x1600 to safe size
        
        'Replace image src with the new saved file
        context.Response.Write("<html><body onload=""parent.applyLargerImage('" & sPath & rndStr & ".jpg" & "')""></body></html>")
    End Sub
